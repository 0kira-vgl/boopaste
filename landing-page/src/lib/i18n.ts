...
const en = {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "If the clipboard holds an image, it's written to disk as a PNG and the clipboard is swapped to that file path — just before the paste event reaches the terminal — then restored right after.",
      },
    ],
    closing:
  ...
  terminals: {
    ...
    closingPre:
      "Ghostty support ships today. Native macOS Terminal.app is next — the frontmost-app check in",
...
const pt: typeof en = {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Se o clipboard tem uma imagem, ela é salva em disco como PNG e o clipboard é trocado pra esse caminho de arquivo — bem antes do evento de paste chegar no terminal — e restaurado logo em seguida.",
      },
    ],
    closing:
  ...
  terminals: {
    ...
    closingPre:
      "O suporte ao Ghostty já funciona hoje. O Terminal nativo do macOS é o próximo — a checagem de app em foco em",
